...
export function WidgetCard({
  ...
  return (
    ...
    >
      <div className={`group relative flex h-full flex-col rounded-2xl border border-border/60 bg-surface-1/60 p-4 backdrop-blur-sm transition hover:border-border sm:p-5 ${editing ? "ring-1 ring-primary/30" : ""}`}>
        {editing && (
