/**
 * Marca provisória do MakersHub — "N" com contraformas em folha.
 * SVG self-contained (cores fixas) para ficar idêntico em qualquer tema/tamanho.
 */
export function LogoMakersHub({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg" role="img" aria-label="MakersHub">
