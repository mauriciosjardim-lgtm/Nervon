...
function Login() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    // Recarrega a raiz para o loader server-side reler `mh_s=1`. Uma navegação
    // SPA manteria o loader inicial (visitante) em cache e exibiria a landing.
        ...
        <div className="relative flex flex-1 items-center">
          <div className="max-w-md">
            <h1 className="font-display text-[2.6rem] font-bold leading-tight tracking-tight text-foreground">
              Organize ideias.
              <br />
              <span className="text-primary">Colabore</span> com seu time.
              <br />
              ...
              {resetEnviado ? (
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Verifique seu e-mail <strong className="text-foreground">{email}</strong> e
