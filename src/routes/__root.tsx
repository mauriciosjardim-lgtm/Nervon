...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nervon — O Hub Completo para Produtoras de Audiovisual" },
      { name: "description", content: "Nervon centraliza CRM, propostas, contratos, projetos, agenda e financeiro da sua produtora audiovisual em um único hub." },
      { name: "theme-color", content: "#0a0a0a" },
      { property: "og:title", content: "Nervon — O Hub Completo para Produtoras de Audiovisual" },
      { property: "og:description", content: "Nervon centraliza CRM, propostas, contratos, projetos, agenda e financeiro da sua produtora audiovisual em um único hub." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Nervon — O Hub Completo para Produtoras de Audiovisual" },
      { name: "twitter:description", content: "Nervon centraliza CRM, propostas, contratos, projetos, agenda e financeiro da sua produtora audiovisual em um único hub." },
